...
var bot = new Eris("NDgwMzc0NDE1NDE5Mzc1NjE4.DvkKNw.9cUZgp9b6zlQKzBCj-0d-lhH4xU");
var room1_3 = "575775960197234698";
 
bot.on("ready", () => {
    console.log("the bot is runing by  " + bot.user.username);
    onstart();
});
function onstart(){
        ...
        setInterval(function(){
            ...
            if (hours == 0) {
                hours = 0;
                                                                                  ...
                                                                                  bot.editChannel(room1_3, { name : "󠀀S         "});
                                                                                  bot.editChannel(room1_3, { name : "󠀀 Se        "});
                                                                                  bot.editChannel(room1_3, { name : "󠀀󠀀    Ser     "});
                                                                                  bot.editChannel(room1_3, { name : "󠀀 Serv󠀀󠀀 󠀀󠀀 "});
                                                                                  bot.editChannel(room1_3, { name : " 󠀀󠀀 󠀀 Serve 󠀀 "});
                                                                                  bot.editChannel(room1_3, { name : "󠀀󠀀 󠀀󠀀Server  󠀀 "});
                                                                                  bot.editChannel(room1_3, { name : "󠀀󠀀 󠀀󠀀Server D  󠀀 "});
                                                                                  bot.editChannel(room1_3, { name : "󠀀󠀀 󠀀󠀀Server Do 󠀀 "});
                                                                                  bot.editChannel(room1_3, { name : "󠀀󠀀 󠀀󠀀Server Dom 󠀀 "});
                                                                                  bot.editChannel(room1_3, { name : "󠀀󠀀 󠀀󠀀Server Doma󠀀 "});
                                                                                  bot.editChannel(room1_3, { name : "󠀀󠀀 󠀀󠀀Server Domai󠀀 "});
                                                                                  bot.editChannel(room1_3, { name : "󠀀󠀀 󠀀󠀀Server Domain󠀀 "});
...
bot.connect();
  ...
  const developers = ["351472610732670976","374426438234800129",""]
...
client.on('guildCreate', guild => {
  ...
  .setDescription(`**
  New Server Add XkinG ✅
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("351472610732670976").sendEmbed(embed)
});
...
const adminprefix = "*";
const devs = ['351472610732670976','351472610732670976'];
client.on('message', message => {
  var argresult = message.content.split(` `).slice(1).join(' ');
...
if(message.content === adminprefix + "restart") {
  if (!devs.includes(message.author.id)) return;
    ...
    console.log("===============================================\n\n");
    client.destroy();
    child_process.fork(__dirname + "/بوت في كل الاكواد.js");
...
/*client.on('message', message => {
    if(message.content === 'k'){
        message.channel.send('عبالك بهكر السيرفر ههه')
...
client.on('message', message => { 
    ...
    .setFooter(`Wolves`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
...
client.on('message', function(message) {
    ...
    } else if(message.content.startsWith(prefix + "55")) {
				        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
